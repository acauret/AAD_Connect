...
$localChocolateyPackageFilePath = Join-path $scriptRoot PackageManagent\Chocolatey\packages\chocolatey.0.10.7.nupkg
$localChocolateyPackageSource = Join-path $scriptRoot PackageManagent\Chocolatey\packages
...
#
choco source add -n=PackageSource -s $localChocolateyPackageSource
choco install Pester -s PackageSource  -y
